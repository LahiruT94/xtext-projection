...
set CLASSPATH=%APP_HOME%\lib\projection-language-server-ls.jar

@rem Execute com.ifs.lang.projection.ide
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %COM_IFS_LANG_PROJECTION_IDE_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
